      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 bg-[#0c0824]/95 p-6 shadow-[0_0_50px_rgba(234,179,8,0.15)] backdrop-blur-3xl sm:p-8"
          >
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative mb-5 flex h-24 w-20 items-center justify-center rounded-2xl bg-white p-2.5 shadow-[0_8px_30px_rgba(255,255,255,0.12)] border border-yellow-400/50">
                <img
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full border border-yellow-500/30 bg-linear-to-r from-yellow-500/15 via-amber-500/10 to-yellow-500/15 px-4 py-1.5 text-[10px] font-extrabold tracking-widest text-yellow-400 uppercase shadow-inner">
                <span className="h-1.5 w-1.5 rounded-full bg-yellow-400 animate-pulse" />
                FIFA World Cup 2026
              </span>

              {/* Title */}
              <h3 className="mt-4 text-3xl sm:text-4xl font-extrabold tracking-tight text-white leading-none">
                Official Joint <br />
            ...
            {/* Announcement text */}
            <div className="mt-6 rounded-2xl border border-white/5 bg-white/[0.02] p-4.5 relative overflow-hidden">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              {/* BTV */}
              <div className="flex flex-col items-center justify-center rounded-2xl border border-white/5 bg-white/[0.02] p-3 text-center transition-all duration-300 hover:bg-white/[0.06] hover:border-yellow-500/20 hover:-translate-y-1 group">
                <div className="flex h-14 w-full items-center justify-center rounded-xl bg-white p-2 shadow-md border border-white/10 group-hover:scale-105 transition-transform duration-300">
                  <img
                ...
                <span className="mt-2.5 text-[10px] font-extrabold tracking-wider text-zinc-400 group-hover:text-yellow-400 transition-colors">BTV</span>
              </div>
              ...
              <div className="flex flex-col items-center justify-center rounded-2xl border border-white/5 bg-white/[0.02] p-3 text-center transition-all duration-300 hover:bg-white/[0.06] hover:border-yellow-500/20 hover:-translate-y-1 group">
                ...
                <span className="mt-2.5 text-[10px] font-extrabold tracking-wider text-zinc-400 group-hover:text-yellow-400 transition-colors">T Sports</span>
              </div>
              ...
              <div className="flex flex-col items-center justify-center rounded-2xl border border-white/5 bg-white/[0.02] p-3 text-center transition-all duration-300 hover:bg-white/[0.06] hover:border-yellow-500/20 hover:-translate-y-1 group">
                ...
                <span className="mt-2.5 text-[10px] font-extrabold tracking-wider text-zinc-400 group-hover:text-yellow-400 transition-colors">Somoy TV</span>
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-2">
              <button
                onClick={handleClose}
                className="w-full flex items-center justify-center gap-2 rounded-2xl bg-linear-to-r from-yellow-500 via-amber-500 to-orange-500 px-6 py-3.5 text-sm font-black text-black shadow-lg shadow-yellow-500/25 transition-all hover:from-yellow-400 hover:to-orange-500 hover:shadow-yellow-500/40 hover:scale-[1.01] active:scale-[0.99] cursor-pointer text-center font-bold"
              >
                <Play className="h-4 w-4 fill-black text-black animate-pulse" />
